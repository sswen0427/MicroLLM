...
TEST(CudaEmbTest, NoStream) {
  ...
  // init input
  tensor::Tensor input =
      tensor::Tensor::allocate(base::DataType::kDataTypeFp32, {1}, base::DeviceType::kDeviceCPU);
  input.at<int32_t>(0) = 1;

  // init weight
  tensor::Tensor weight = tensor::Tensor::allocate(
      base::DataType::kDataTypeFp32, {token, dim}, base::DeviceType::kDeviceCPU);
  ...
  tensor::Tensor output =
      tensor::Tensor::allocate(base::DataType::kDataTypeFp32, {dim}, base::DeviceType::kDeviceCUDA);
